...
public class App {
  ...
  private static void cadastrar(String dados) {
    String[] dadosSeparados = dados.split(",");
    if (dadosSeparados == null) {
      JOptionPane.showMessageDialog(null, "favor informar pelo menos um campo ", "nulo",
          JOptionPane.INFORMATION_MESSAGE);
    } else {
      Cliente cliente = new Cliente(
          (dadosSeparados[0] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[0],
          (dadosSeparados[1] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[1],
          (dadosSeparados[2] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[2],
          (dadosSeparados[3] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[3],
          (dadosSeparados[4] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[4],
          (dadosSeparados[5] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[5],
          (dadosSeparados[6] == null || dadosSeparados[0].equals("")) ? null : dadosSeparados[6]);
